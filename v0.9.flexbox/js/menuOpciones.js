...
function insertaOpcionesMenu() {
  const opcionesHTML =
    ...
    '<li data-vista="listaPacientes" class="itemOpcionesMenu">Pacientes</li>' +
    '<li data-vista="listaPruebas" class="itemOpcionesMenu">Pruebas</li>';
  ...
  //   return `<li data-vista="${vistaOpciones[opcion]} class="itemOpcionesMenu">${opcion}</li>`;
  // });
